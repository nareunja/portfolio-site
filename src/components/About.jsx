        ...
        <div className="flex flex-col md:flex-row gap-16 item-start">
            ...
            <div className="w-full md:w-2/3 flex flex-col justify-between">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-16">
                    {/* TOOL */}
                    <div>
                        <h4 className="text-sm font-bold text-white/40 mb-6 uppercase tracking-widest font-montserrat">Tool</h4>
                    ...
                    {/* EXPERIENCES */}
                    <div>
                        <h4 className="text-sm font-bold text-white/40 mb-6 uppercase tracking-widest font-montserrat">Experiences</h4>
                    ...
                    {/* EDUCATION */}
                    <div>
                        <h4 className="text-sm font-bold text-white/40 mb-6 uppercase tracking-widest font-montserrat">Education</h4>
                        <ul className="text-slate-300 space-y-2 font-light text-lg">
                            <li>성신여자대학교 졸업 예정</li>
                            <li>광양제철고등학교 졸업</li>
                        </ul>
                    ...
                    {/* CERTIFICATE */}
                    <div>
                        <h4 className="text-sm font-bold text-white/40 mb-6 uppercase tracking-widest font-montserrat">Certificate</h4>
